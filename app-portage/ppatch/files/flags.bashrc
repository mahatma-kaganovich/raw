...
# gtkmm too (cdrdao)
icedtea|qtwebkit|xf86-video-intel|mplayer|gtkmm|mysql|mariadb|heimdal|glibc|vcs|libreoffice|samba|xfsprogs|ncurses|lynx)filterflag '-flto*' '-*-lto-*' -fuse-linker-plugin;;&
