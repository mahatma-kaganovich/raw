...
# gtkmm too (cdrdao)
icedtea|dhcp|php|qtwebkit|xf86-video-intel|mplayer|gtkmm|mysql|mariadb|clamav|heimdal|glibc|lxc|qemu|elfutils|cvs|lksctp-tools|libreoffice|samba|pciutils|xfsprogs|numactl|ncurses|alsa-lib|lynx|pinentry)filterflag '-flto*' '-*-lto-*' -fuse-linker-plugin;;&
