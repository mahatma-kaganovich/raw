...
# gtkmm too (cdrdao)
icedtea|qtwebkit|xf86-video-intel|mplayer|gtkmm|mysql|heimdal|glibc|elfutils|lksctp-tools|libreoffice|samba|pciutils|xfsprogs|numactl|ncurses|alsa-lib|lynx|pinentry)filterflag '-flto*' '-*-lto-*' -fuse-linker-plugin;;&
