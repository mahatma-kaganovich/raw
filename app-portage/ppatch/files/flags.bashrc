...
# gtkmm too (cdrdao)
php|qtwebkit|xf86-video-intel|mplayer|gtkmm|mysql|mariadb|clamav|heimdal|glibc|lxc|qemu|elfutils|cvs|lksctp-tools|libreoffice|samba|pciutils|xfsprogs|numactl|ncurses|alsa-lib|lynx)filterflag '-flto*' '-*-lto-*' -fuse-linker-plugin;;&
...
sqlite|postgresql*|goffice|db|protobuf|qtwebkit|webkit-gtk|python|guile|chromium)filterflag -Ofast -ffast-math;;&
