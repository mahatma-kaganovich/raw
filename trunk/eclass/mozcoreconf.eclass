...
mozconfig_init() {
	...
	# seamonkey 1.1.14 was work without pango
	# you may also remove pango from dependences, but I don't need it
	mozconfig_use_enable !moznopango pango

	# I don't want unstripped code. you need? why?
