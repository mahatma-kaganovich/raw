...
kernel-2_pkg_postinst() {
	...
	if use update-boot; then
		local m
		which grub2-mkconfig && m=grub2-mkconfig || m=grub-mkconfig
		grep -sq "It is automatically generated by grub2*-mkconfig using templates" ${ROOT}/boot/grub2/grub.cfg && $m -o ${ROOT}/boot/grub2/grub.cfg
		# todo: lilo?
