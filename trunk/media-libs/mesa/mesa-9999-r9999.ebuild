...
src_configure() {
	...
	if use gallium; then
		...
		myconf="${myconf} --disable-gallium-intel --disable-gallium-i915 --disable-gallium-i965 --disable-gallium-radeon --disable-gallium-r300 --disable-gallium-r600 --with-state-trackers=dri,egl,glx"
	fi
