...
$ENV{KERNEL_CONFIG}||='
	...
	MEMORY_HOTPLUG MEMORY_HOTREMOVE
	    ZONE_DEVICE HSA_AMD DEVICE_PRIVATE HSA_AMD_SVM
	...
	=ZRAM_.+_COMPRESS =ZRAM_BACKEND_.+ =TUN_VNET_CROSS_LE =VHOST_CROSS_ENDIAN_LEGACY =THERMAL_WRITABLE_TRIPS
	=DRM_GMA.+
	...
	IOSF_MBI X86_INTEL_LPSS =DRM_MEDFIELD =.+_(?:SOC|SCU)(?:_.+)?

	=X86_AMD_PLATFORM_DEVICE =PINCTRL_AMD
	AMD_IOMMU_V2
	=I2C_DESIGNWARE_AMDPSP CRYPTO_DEV_CCP_CRYPTO
	...
	###X86_AMD_PSTATE_DEFAULT_MODE=2 #passive+schedutil ##conservative?
	=BLK_SED_OPAL
