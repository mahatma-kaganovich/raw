...
$ENV{KERNEL_CONFIG}||='
	...
	FB_SIMPLE DRM==!y;DRM_SIMPLEDRM DRM_SIMPLEDRM==!y;-FB_SIMPLE FB_SIMPLE==!y;-DRM_SIMPLEDRM
	=RXKAD BIG_KEYS
	ARM==y;ARM64==y;-QCOM_.+
	...
	#bug_5.14_FB_SIMPLE DRM_FBDEV_EMULATION FB_EFI ###FB_CFB_FILLRECT==!m;-FB_SIMPLE
