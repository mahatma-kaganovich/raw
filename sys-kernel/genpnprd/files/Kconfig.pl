...
$ENV{KERNEL_CONFIG}||='
	...
	=(?:JOYSTICK|USB|ISDN|JFFS2|MOUSE|RTC|SQUASHFS|ROMFS|BT|DSCC4|ATM|HISAX|GPIO|A11Y|SPI|BCMA|RT2800USB)_[\w\d_]+
	~HISAX_NO_[\w\d_]*
	=[\w\d_]+_(PARTITION|FF)
	DM_UEVENT =[\w\d_]*_SDIO B43_PHY_N
	CIFS_UPCALL NETCONSOLE_DYNAMIC ITCO_VENDOR_SUPPORT NFS_USE_NEW_IDMAPPER
	===bugs: -TR -ECONET
	===udev: -IDE
	=======
	';
