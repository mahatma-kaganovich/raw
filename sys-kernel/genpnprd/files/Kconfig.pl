...
$ENV{KERNEL_CONFIG}||='
	...
	HID_PICOLCD_[\w\d_]* MULTICORE_RAID456
	BT_L2CAP_EXT_FEATURES VGA_SWITCHEROO ACPI_APEI L2TP_V3
	THERMAL_HWMON
	...
	DEVTMPFS_MOUNT PARPORT_PC_SUPERIO BLK_DEV_XIP ISDN_
	=(?:JOYSTICK|USB|ISDN|JFFS2|MOUSE|RTC|SQUASHFS|ROMFS|BT|DSCC4|ATM|HISAX|GPIO|A11Y)_[\w\d_]+
	~HISAX_NO_[\w\d_]*
	=[\w\d_]+_PARTITION
	DM_UEVENT =[\w\d_]*_SDIO B43_PHY_N
	===bugs: -TR -ECONET
	===udev: -IDE
	=======
	';
