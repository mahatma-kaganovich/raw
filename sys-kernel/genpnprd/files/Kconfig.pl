...
$ENV{KERNEL_CONFIG}||='
	...
	=(?:JOYSTICK|USB|ISDN|JFFS2|MOUSE|RTC|SQUASHFS|ROMFS|BT|DSCC4|ATM|HISAX|GPIO|A11Y|SPI|BCMA|RT2800USB|HOTPLUG_PCI|CIFS|NFS|NFC|OF|POWER_RESET|THERMAL_GOV|PCIE|PWM|EDAC)_.+
	...
	~HISAX_NO_.+
	=.+_(?:PARTITION|FF|X_COMPATIBILITY|PTP|IOMMU|THERMAL|API|THERMAL|DAX)
	.+_DUAL_ROLE .+_BY_BOTH
	...
	=INTEL_RDT_?A? INTEL_IOMMU_SVM =INTEL_TURBO_MAX_3 =CHARGER_MANAGER
